        ...
        <main class="app-main" id="mainContent">
            ...
            <div id="section-inicio">
                ...
                <div style="margin-top:20px;padding:20px;border:1px solid var(--gray-light);border-radius:var(--radius)">
                    <h3 style="color:var(--blue);margin-bottom:10px">ETECSA &mdash; Empresa de Telecomunicaciones de Cuba, S.A.</h3>
                    <p style="color:var(--black);font-size:13px;line-height:1.8">
                        ETECSA es la única empresa de telecomunicaciones de Cuba, fundada en 1994.
                        Brinda servicios de telefonía fija, mívil, transmisión de datos e internet.
                        Division Pinar del Río &mdash; Sistema de Gestion de Trabajadores v1.0.
                    </p>
                </div>
            </div>
